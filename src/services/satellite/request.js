...
// Include a processing version in the request hash. Changing a source or an
// algorithm must never return an image generated by a previous pipeline.
const PRODUCT_VERSIONS = Object.freeze({
    rgb: 'optical-v2',
    ndvi: 'optical-v2',
    heatmap: 'landsat-lst-v1',
    classified: 'campha-landcover-12-v1',
    'fire-risk': 'fire-risk-v1',
});
...
const normalizeRequest = (imageType, raw = {}) => {
    ...
    return {
        type,
        productVersion: PRODUCT_VERSIONS[type] || 'v1',
        startDate,
        endDate,
