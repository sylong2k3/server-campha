...
const M5_ARTIFACTS = Object.freeze([
    {
        code: 'trend_frequency',
        role: 'PRODUCT',
        style: 'trend_frequency',
        label: { vi: 'Tần suất ngập (%)', en: 'Flood frequency (%)' },
    },
    {
        code: 'trend_frequent_flood',
        role: 'PRODUCT',
        style: 'trend_frequent_flood',
        label: { vi: 'Vùng ngập tái diễn', en: 'Frequent flood' },
    },
    {
        code: 'trend_new_flood',
        role: 'PRODUCT',
        style: 'trend_new_flood',
    ...
    },
    {
        ...
        label: { vi: 'Vùng nhạy cảm tiêu thoát', en: 'Drainage-sensitive' },
    },
    {
    ...
    {
        code: 'trend_tidal_candidate',
        role: 'QA',
        style: 'trend_tidal_candidate',
        label: { vi: 'Ứng viên vùng triều (QA)', en: 'Tidal candidate (QA)' },
    },
    {
        code: 'trend_mining_candidate',
        role: 'QA',
        style: 'trend_mining_candidate',
