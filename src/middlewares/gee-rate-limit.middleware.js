...
const geeManualTriggerLimiter = buildLimiter({
    windowMs: Number.parseInt(process.env.GEE_TRIGGER_RATE_WINDOW_MS, 10) || 15 * 60 * 1000,
...
const geeQueryLimiter = buildLimiter({
    windowMs: Number.parseInt(process.env.GEE_QUERY_RATE_WINDOW_MS, 10) || 15 * 60 * 1000,
