const locales = {
    vi: {
        web_map_forbidden: 'Không có quyền sử dụng chức năng bản đồ này',
        web_map_layer_not_found: 'Không tìm thấy lớp bản đồ',
        web_map_feature_not_found: 'Không tìm thấy đối tượng bản đồ',
        web_map_not_vector: 'Lớp này không hỗ trợ truy vấn thuộc tính',
        web_map_layers_success: 'Lấy danh mục lớp bản đồ thành công',
        web_map_feature_success: 'Lấy thuộc tính đối tượng thành công',
        web_map_search_success: 'Tìm kiếm đối tượng thành công',
        web_map_legend_success: 'Lấy chú giải lớp thành công',
        web_map_basemaps_success: 'Lấy danh mục bản đồ nền thành công',
        web_map_terrain_success: 'Lấy danh mục địa hình thành công',
        web_map_terrain_url_success: 'Tạo liên kết dữ liệu địa hình thành công',
        ...
        satellite_forbidden: 'Không có quyền thực hiện thao tác ảnh vệ tinh',
        satellite_not_found: 'Không tìm thấy ảnh vệ tinh',
        satellite_coverage_mismatch: 'Hai ảnh không cùng khu vực',
        satellite_time_order_invalid: 'Ảnh trước phải có thời gian thu nhận sớm hơn ảnh sau',
        satellite_invalid_file: 'File GeoTIFF chưa sẵn sàng hoặc không thuộc người dùng',
        satellite_conflict: 'Mã cảnh hoặc file đã tồn tại',
        satellite_optimistic_conflict: 'Dữ liệu đã thay đổi; vui lòng tải lại',
        satellite_list_success: 'Danh sách ảnh vệ tinh',
        satellite_admin_list_success: 'Danh sách ảnh vệ tinh quản trị',
        satellite_detail_success: 'Chi tiết ảnh vệ tinh',
        satellite_compare_success: 'Cặp ảnh so sánh',
        satellite_download_success: 'URL tải ảnh vệ tinh',
        satellite_created_success: 'Đã thêm ảnh vệ tinh',
        satellite_categorized_success: 'Đã phân nhóm ảnh vệ tinh',
        satellite_deleted_success: 'Đã xóa ảnh vệ tinh',
        ...
        field_report_public_success: 'Lấy danh sách phản ánh công khai thành công',
        field_report_nearby_success: 'Lấy thay đổi tại vị trí thành công',
        field_report_mine_success: 'Lấy phản ánh của tôi thành công',
        field_report_created_success: 'Gửi phản ánh thành công',
        field_report_detail_success: 'Lấy chi tiết phản ánh thành công',
        field_report_deleted_success: 'Đã xóa phản ánh theo yêu cầu',
        field_report_admin_success: 'Lấy danh sách quản trị phản ánh thành công',
        field_report_reviewed_success: 'Cập nhật trạng thái phản ánh thành công',
        field_report_clusters_success: 'Lấy cụm phản ánh thành công',
        field_report_device_registered: 'Đăng ký thiết bị thành công',
        field_report_device_removed: 'Gỡ thiết bị thành công',
        mobile_feature_success: 'Lấy thuộc tính đối tượng thành công',
        mobile_nearby_success: 'Lấy đối tượng lân cận thành công',
        mobile_measure_success: 'Đo đạc thành công',
        mobile_draft_created_success: 'Tạo bản phác thảo thành công',
        mobile_drafts_success: 'Lấy bản phác thảo thành công',
        mobile_draft_deleted_success: 'Xóa bản phác thảo thành công',
        mobile_weather_success: 'Lấy thời tiết hiện tại thành công',
        mobile_route_success: 'Tìm tuyến đường ngắn nhất thành công',
        mobile_topology_rebuilt_success: 'Xây dựng topology mạng đường thành công',
        mobile_topology_success: 'Lấy bằng chứng topology thành công',
        mobile_feature_updated_success: 'Cập nhật đối tượng bản đồ thành công',
        mobile_feature_history_success: 'Lấy lịch sử phiên bản thành công',
        mobile_feature_restored_success: 'Khôi phục phiên bản đối tượng thành công',
        mobile_sync_success: 'Đồng bộ thay đổi ngoại tuyến hoàn tất',
        ...
        mfa_required: 'Cần xác thực đa yếu tố để hoàn tất đăng nhập',
        mfa_challenge_invalid: 'Yêu cầu xác thực đa yếu tố không hợp lệ hoặc đã hết hạn',
        mfa_code_invalid: 'Mã xác thực không hợp lệ hoặc đã được sử dụng',
        mfa_code_required: 'Chỉ cung cấp một mã TOTP hoặc mã khôi phục',
        mfa_already_enabled: 'Xác thực đa yếu tố đã được kích hoạt',
        mfa_setup_ready: 'Đã tạo thông tin thiết lập MFA',
        mfa_enabled: 'Kích hoạt MFA thành công. Hãy lưu mã khôi phục an toàn',
        sessions_retrieved: 'Lấy danh sách phiên đăng nhập thành công',
        session_revoked_success: 'Đã thu hồi phiên đăng nhập',
        ...
        feedback_notify_new_body: 'Phản ánh "{title}" vừa được gửi, cần kiểm tra',
        ...
        raster_ingest_deduplicated: 'Job cùng URL đang được xử lý, trả về job hiện có',
        raster_ingest_job_not_found: 'Không tìm thấy job ingest',
        raster_ingest_job_get_success: 'Lấy thông tin job ingest thành công',
        raster_ingest_jobs_list_success: 'Lấy danh sách job ingest thành công',
        ...
        statistics_forbidden: 'Không có quyền xem hoặc phân tích số liệu không gian',
        statistics_source_conflict: 'Nguồn thống kê đã tồn tại hoặc dữ liệu đã thay đổi',
        statistics_refresh_busy: 'Nguồn đang được làm mới; vui lòng thử lại sau',
        statistics_source_invalid: 'Lớp hoặc cấu hình nguồn thống kê không hợp lệ',
        statistics_source_not_found: 'Không tìm thấy nguồn thống kê',
        statistics_boundary_not_found: 'Không tìm thấy nguồn ranh giới hành chính',
        statistics_compare_invalid: 'Hai nguồn không thể so sánh',
        statistics_sources_success: 'Lấy danh sách nguồn thống kê thành công',
        statistics_areas_success: 'Lấy số liệu diện tích thành công',
        statistics_timeseries_success: 'Lấy chuỗi số liệu theo thời gian thành công',
        statistics_compare_success: 'So sánh không gian thành công',
        statistics_source_created_success: 'Đã đăng ký nguồn thống kê',
        statistics_source_updated_success: 'Đã cập nhật nguồn thống kê',
        statistics_refresh_success: 'Đã làm mới số liệu thống kê',
        ...
        field_measurement_out_of_province: 'Vị trí đo nằm ngoài ranh giới thành phố Cẩm Phả',
        ...
        // ── Log hệ thống ──────────────────────────────────────────────────────
        system_logs_cleaned_success: 'Đã dọn {count} bản ghi log hệ thống cũ',
        server_started_log: 'Server khởi động thành công trên cổng {port}',
     ...
     en: {
        ...
        web_map_not_vector: 'This layer does not support attribute queries',
        web_map_layers_success: 'Map layer catalog retrieved successfully',
        web_map_feature_success: 'Feature attributes retrieved successfully',
        web_map_search_success: 'Features searched successfully',
        web_map_legend_success: 'Layer legend retrieved successfully',
        web_map_basemaps_success: 'Basemap catalog retrieved successfully',
        web_map_terrain_success: 'Terrain catalog retrieved successfully',
        web_map_terrain_url_success: 'Terrain data URL created successfully',
        ...
        satellite_created_success: 'Satellite image added successfully',
        satellite_categorized_success: 'Satellite image categorized successfully',
        satellite_deleted_success: 'Satellite image deleted successfully',
        ...
        field_report_public_success: 'Public field reports retrieved successfully',
        field_report_nearby_success: 'Nearby changes retrieved successfully',
        field_report_mine_success: 'Your field reports retrieved successfully',
        field_report_created_success: 'Field report submitted successfully',
        field_report_detail_success: 'Field report details retrieved successfully',
        field_report_deleted_success: 'Field report deleted on subject request',
        field_report_admin_success: 'Administrative field reports retrieved successfully',
        field_report_reviewed_success: 'Field report status updated successfully',
        field_report_clusters_success: 'Field report clusters retrieved successfully',
        field_report_device_registered: 'Device registered successfully',
        field_report_device_removed: 'Device removed successfully',
        mobile_feature_success: 'Feature attributes retrieved successfully',
        mobile_nearby_success: 'Nearby features retrieved successfully',
        mobile_measure_success: 'Measurement completed successfully',
        mobile_draft_created_success: 'Draft created successfully',
        mobile_drafts_success: 'Drafts retrieved successfully',
        mobile_draft_deleted_success: 'Draft deleted successfully',
        mobile_weather_success: 'Current weather retrieved successfully',
        mobile_route_success: 'Shortest route calculated successfully',
        mobile_topology_rebuilt_success: 'Road-network topology rebuilt successfully',
        mobile_topology_success: 'Topology evidence retrieved successfully',
        mobile_feature_updated_success: 'Map feature updated successfully',
        mobile_feature_history_success: 'Feature version history retrieved successfully',
        mobile_feature_restored_success: 'Feature version restored successfully',
        ...
        mfa_challenge_invalid: 'The multi-factor authentication request is invalid or expired',
        mfa_code_invalid: 'The authentication code is invalid or already used',
        mfa_code_required: 'Provide exactly one TOTP or recovery code',
        mfa_already_enabled: 'Multi-factor authentication is already enabled',
        mfa_setup_ready: 'MFA setup information generated',
        mfa_enabled: 'MFA enabled. Store the recovery codes securely',
        ...
        feedback_notify_new_body: 'Report "{title}" was just submitted and needs review',
        ...
        statistics_forbidden: 'You do not have permission to view or analyze spatial statistics',
        statistics_source_conflict: 'The statistics source already exists or its data has changed',
        statistics_refresh_busy: 'The source is already being refreshed; try again later',
        statistics_source_invalid: 'The layer or statistics source configuration is invalid',
        statistics_source_not_found: 'Statistics source not found',
        statistics_boundary_not_found: 'Administrative boundary source not found',
        statistics_compare_invalid: 'The two sources cannot be compared',
        statistics_sources_success: 'Statistics sources retrieved successfully',
        statistics_areas_success: 'Area statistics retrieved successfully',
        statistics_timeseries_success: 'Statistics time series retrieved successfully',
        statistics_compare_success: 'Spatial comparison completed successfully',
        statistics_source_created_success: 'Statistics source registered successfully',
        statistics_source_updated_success: 'Statistics source updated successfully',
        statistics_refresh_success: 'Statistics refreshed successfully',
        ...
        // ── System logs ───────────────────────────────────────────────────────
        system_logs_cleaned_success: 'Cleaned up {count} old system log record(s)',
        server_started_log: 'Server started successfully on port {port}',
